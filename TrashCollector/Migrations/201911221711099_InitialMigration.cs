                ...
                c => new
                    {
                        ...
                        LastName = c.String(),
                        PickUpDay = c.String(),
                        ServiceSuspended = c.Boolean(nullable: false),
                        ServiceStartTime = c.DateTime(nullable: true),
                        ServiceEndTime = c.DateTime(nullable: true),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        TimeOfPickUp = c.DateTime(nullable: true),
